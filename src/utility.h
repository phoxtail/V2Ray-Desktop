...
public:
    ...
    static QString getNumericConfigError(const QJsonObject &serverConfig, const QString &key,
                                         const QString &name, int lowerBound, int upperBound);
    static QString
    getStringConfigError(const QJsonObject &serverConfig, const QString &key, const QString &name,
    ...
    static QString getLatestRelease(const QString &releaseUrl, const QNetworkProxy *proxy);
    static bool isVersionNewer(const QString &currentVersion, const QString &version);
    static QList<int> getVersion(QString version);
    static QString getReleaseAssets(const QString &assetsUrl, const QString &fileName,
