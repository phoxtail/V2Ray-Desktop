...
V2RayCore::V2RayCore()
{
    ...
    QString srcMmdbFilePath = QDir(v2RayInstallFolderPath).filePath("Country.mmdb");
    QString dstMmdbFilePath = QFileInfo(configFilePath).dir().filePath("Country.mmdb");
...
{
    return QFile(v2RayExecFilePath).exists();
}
